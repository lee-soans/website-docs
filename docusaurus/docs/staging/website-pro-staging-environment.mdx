...
![Staging view with no environment](./img/staging-view-no-environment.jpg)

The site below has a staging environment:

![Staging with environment](./img/staging-with-environment.jpg)
...
![Preserve staging files checkbox](./img/preserve-staging-files.jpg)

## Resetting a Staging Site

There are 3 ways to reset your staging site:

![Reset staging site options](./img/reset-staging-site.jpg)
