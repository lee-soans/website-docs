...
title: Importing WordPress sites into WordPress Hosting
description: Learn how to import your WordPress sites into WordPress Hosting through DIY or managed migration options.
sidebar_position: 1
---

# Importing WordPress sites into WordPress Hosting
...
Select the account in Partner Center and activate WordPress Hosting. ([Instructions](/vendasta-products/activate-products))
