...
description: Learn how to enable or disable the default Google Analytics tracking in WordPress Hosting to manage GDPR compliance
slug: /products/wordpress-hosting/advanced-tools/toggle-google-analytics
---
...
![Advanced tools menu option](./img/ga-tracking-1.jpg)

3. Toggle the option for the Google Analytics Integration

![Google Analytics toggle](./img/ga-tracking-2.jpg)

4. Click on Accept

![Accept button](./img/ga-tracking-3.jpg)