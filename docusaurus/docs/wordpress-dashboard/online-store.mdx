...
![WordPress plugins page](./img/woocommerce-setup-1.jpg)

4. In the search field, type "WooCommerce" and press Enter.
5. Click on the **Install Now** button next to the WooCommerce plugin.

![Installing WooCommerce plugin](./img/woocommerce-setup-2.jpg)

6. After installation is complete, click on **Activate Plugin**.

![WooCommerce plugin installation](./img/woocommerce-plugin-install.jpg)

![Activating WooCommerce](./img/woocommerce-activate.jpg)
...
![WooCommerce Setup Wizard](./img/woocommerce-setup-wizard.jpg)
...
![WooCommerce Store Admin](./img/woocommerce-store-admin.jpg)
