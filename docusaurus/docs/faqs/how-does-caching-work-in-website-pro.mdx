---
title: How does caching work in WordPress Hosting?
description: Learn about web caching in WordPress Hosting, how it speeds up site performance, and how to manage cached content.
sidebar_label: Caching in WordPress Hosting
---
...
Caching static files reduces several systems between an end-user requesting your website and the delivery of the WordPress PHP files and, thus, speeds up your WordPress site load time. Caching can be implemented on several levels, and WordPress Hosting has one level of caching implemented for you.

### **WordPress Hosting built-in caching**

WordPress Hosting has a reverse proxy layer implemented with Nginx. Nginx is very fast and has an efficient caching mechanism. 
...
Currently, WordPress Hosting caches all content that matches the following criteria for 1 hour:
