...
Now you will be able to change the upload limit up to 256MB in WordPress Hosting.

![File upload limit settings](./img/wordpress/wp-upload-limit-settings.jpg)

:::note
Please note: The **maximum** file upload limit in WordPress Hosting is 256 MB. Anything above that would result in an error. In which case, we can suggest [making use of SPTF to upload Files above 256 MB](/vendasta-products/vendasta-products-website/vendasta-products-website-faqs/uploading-large-files-with-sptf).
:::