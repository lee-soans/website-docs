...
description: "Information about WordPress Hosting's caching and how to see content updates immediately"
---
...
One of the things that makes WordPress Hosting fast is the caching we perform in Nginx and Google CDN. As a result, when updates are performed site owners will need to clear the cache if they want their customers to see the changes immediately.
...
WordPress Hosting does not cache URLs with query parameters.
