---
title: Can I connect to site databases from outside WordPress Hosting like using Mysql Workbench or other remote db client?
sidebar_label: External database connections
description: Information about accessing WordPress Hosting databases from external database clients
---
