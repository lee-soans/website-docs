...
description: Learn about increasing the upload limit for the All-in-One WP Migration plugin in WordPress Hosting.
...
In WordPress Hosting, most pre-installed templates come with either a 64 MB limit or an unlimited upload limit, depending on the plugin version. For migrating larger sites, you'll need the **All-in-One WP Migration Unlimited** extension.
