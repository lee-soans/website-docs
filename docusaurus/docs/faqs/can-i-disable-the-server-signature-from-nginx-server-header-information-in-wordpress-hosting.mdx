---
title: Can I Disable the Server Signature from NGINX Server Header Information in WordPress Hosting?
sidebar_label: Disabling NGINX server signature
description: Information about the server signature in NGINX Server Header Information in WordPress Hosting and whether it can be disabled
---
