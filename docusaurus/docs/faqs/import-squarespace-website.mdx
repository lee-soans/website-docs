---
title: Can I import a Squarespace Website into WordPress Hosting?
description: Learn how to import your Squarespace website into WordPress Hosting using the WordPress export/import functionality.
...
{/* ![Squarespace export menu](/img/squarespace-import/step1-export-menu.jpg) */}
...
![Squarespace export to WordPress](./img/step2-export-wordpress.jpg)

## Step 3

Log in to your WordPress admin area and go to the **Tools > Import** page. You will see a list of platforms to choose from.

![WordPress import tools](./img/step3-wordpress-import-tools.jpg)
...
![Run WordPress importer](./img/step4-run-importer.jpg)
...
![Import settings](./img/step5-import-settings.jpg)