...
description: Learn how to manually import a WordPress site into WordPress Hosting when you don't want to use migration plugins.
sidebar_label: Importing WordPress Site Manually
---

If you do not wish to use a migration plugin–such as if your site is larger than the supported size or you've already exported your site from your previous host–you can manually import that site into WordPress Hosting. Please note that if you need the current WordPress Hosting site to stay active, you may wish to import your site to your staging environment.
...
## Step 3: Import your database to WordPress Hosting.

1. From **WordPress Hosting**, open **Advanced Tools** > **PHPMyAdmin**.
   ![PHPMyAdmin Access](/img/4410986742679.png)

2. Select the database created by WordPress Hosting. This will take the form of *db_##*.
...
3. Click **Import**. Under **File to import**, click **choose file** and select the database file included in your site export. This will generally be a .sql file.
   ![Import Database](./img/importdb.png)
...
Of note, as WordPress Hosting aims to make importing as easy as possible, you will not need to update your *wp-config.php* file to point to this database.

## Step 4: Upload your website files to WordPress Hosting

To upload your site, you'll need to make use of [WordPress Hosting's SFTP support](https://help.wordpress.hosting/?p=202). Ensure you upload the entire contents of your WordPress export to the root directory (the first folder that should load when connecting to the server).

## Step 5: Updating your database to use your new domain

*Please note that if you are using the same domain name in WordPress Hosting, you do not need to perform this step.*
...
1. From **WordPress Hosting**, select **phpMyAdmin**
...
4. Under **Inside tables**, click **Select all**, then click **Go**.
   ![Domain Search](./img/domainsearch.png)

5. Click **Browse** next to any of the tables that return results.
   ![Browse Results](./img/browse.png)

6. Double-click on any fields that contain the old domain name and manually enter the new.

## Step 6: Pointing your domain name to WordPress Hosting

Finally, it's time to point your domain over to WordPress Hosting. You can use the steps presented in **WordPress Hosting > Domains** to do so.