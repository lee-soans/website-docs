...
title: How to point a New GoDaddy domain to WordPress Hosting
description: Learn how to point your GoDaddy domain to your WordPress Hosting site with these step-by-step instructions.
sidebar_label: GoDaddy Domain to WordPress Hosting
---

If you recently purchased the domain (or just have never pointed your domain to a site), then these instructions should allow you to point your domain to your WordPress Hosting site. These less specific [Domain connection Instructions](https://help.websitepro.hosting/?p=421) might be more helpful if your [DNS records](https://help.websitepro.hosting/?p=10) are not managed in GoDaddy.
