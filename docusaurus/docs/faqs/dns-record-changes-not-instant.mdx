...
[Domain Name System (DNS) records](https://help.wordpress.hosting/?p=10) are used by the infrastructure of the internet to send data through the correct paths i.e. data from your website to the customer on a website.
