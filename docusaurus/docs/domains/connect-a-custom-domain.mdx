...
description: Learn how to connect your custom domain to your WordPress Hosting site
---
...
3. Edit or create a DNS Record for your new domain.
   - We recommend setting a CNAME Record with a value of *[host.wordpresshosting.com](http://host.wordpresshosting.com/)*.
