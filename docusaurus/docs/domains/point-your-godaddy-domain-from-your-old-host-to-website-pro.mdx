...
description: How to point your GoDaddy domain from an old host to WordPress Hosting while maintaining zero downtime.
---

If your domain is currently pointing to a site on another host, then these instructions should allow you to point your domain to your WordPress Hosting site, with zero downtime. These less specific [Domain Transfer Instructions](https://help.wordpress.hosting/?p=421) might be more helpful if your [DNS records](https://help.wordpress.hosting/?p=10) are not managed in GoDaddy. Follow these [new domain connection instructions](https://help.wordpress.hosting/?p=394) if you are not transferring your domain from a previous host.
...
3. Scroll down to **Additional Settings** and select **Manage DNS.**
   ...
   ![GoDaddy DNS Management Screenshot](./img/domains-manage-dns-godaddy.png)
...
6. If you have a **www** record click the pencil icon at the right side of the row with the **Name** "**www**", make sure it is a "**CNAME**" record, and change the value to ***[host.wordpresshosting.com](http://host.wordpresshosting.com/)***
